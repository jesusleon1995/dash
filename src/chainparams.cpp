...
public:
    CMainParams() {
        ...
        consensus.nMinimumChainWork = uint256S("0x00"); // 782700 0x000000000000000000000000000000000000000000000100a308553b4863b755
        ...
        vSeeds.push_back(CDNSSeedData("178.128.255.16", "178.128.255.16"));
...
public:
    CTestNetParams() {
        ...
        checkpointData = (CCheckpointData) {
            ...
            1390666206UL, // * UNIX timestamp of last checkpoint block
            0,       // * total number of transactions between genesis and last checkpoint
                        //   (the tx=... number in the SetBestChain debug.log lines)
